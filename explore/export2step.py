...
parser.add_argument(
    "--form", type=str, default="h5", choices=["h5", "json"], help="file format"
)
parser.add_argument(
    ...
    try:
        if args.form == "h5":
            with h5py.File(path, "r") as fp:
                out_vec = fp[DATASET_IN_H5][:].astype(np.float64)
        ...
        print(f"load and create failed with message {e}")
        continue
